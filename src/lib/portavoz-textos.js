...
export function textoDe(n, d) {
  ...
  const textos = {
    1:
      ...
      `What you get: $80 in prizes every month, split into several awards: reaching Legend I, finishing first in the league, best war attacker and more. Plus a Telegram community with automatic war alerts and rankings, and leaders who've been here since 2012.\n\n` +
      pie('en'),
    2:
      ...
      `Damos $80 en premios cada mes repartidos en varias tareas: subir a Leyenda I, terminar primero en la liga, ser el mejor atacante de guerra y más. Comunidad en Telegram con avisos automáticos de guerra y ranking de premios, y líderes de la vieja escuela.\n\n` +
      pie('es'),
    3:
      ...
      `Lo que hay dentro: $80 al mes en varios premios (subir a Leyenda I, primero en la liga, mejor atacante de guerra y más), avisos automáticos por Telegram para que no se te pase ningún ataque, y una alianza de cinco clanes con gente de Cuba, de toda Latinoamérica e internacionales.\n\n` +
      pie('es'),
    4:
      ...
      `Damos: $80 al mes en premios por tareas (Leyenda I, primero en la liga, mejor atacante de guerra y más), comunidad en Telegram con avisos y rankings automáticos, y respeto de clan viejo.\n\n` +
      pie('es'),
    5:
      ...
      `Solo TH18 en Liga Leyenda III o superior, adultos y responsables, de guerra y push. Nada de farming ni de turistas. Comunidad en Telegram con avisos automáticos y ranking de premios.\n\n` +
      pie('es'),
    6:
      ...
      `Ofrecemos $80 al mes en varios premios (Leyenda I, primero en la liga, mejor atacante de guerra y más) y una comunidad en Telegram con avisos y rankings automáticos.\n\n` +
      pie('es'),
    7:
