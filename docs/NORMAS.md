...
- Cuando dones, dilo en Telegram con la captura del mapa de guerra donde se vea el castillo de abajo lleno, con `/castillo` en el pie o "@Heraldo ya doné mi castillo". Heraldo la comprueba y suma los puntos solo; sin captura, lo confirma un líder. Así los líderes saben qué falta sin revisar uno por uno.
...
- **Retos**: lo voluntario, que premia entrenar y competir. Hoy: cinco desafíos amistosos con dos estrellas o más en una sola captura del chat del clan, mandada con `/fc` en el pie (o mencionando a Heraldo), una vez al día.
...
Bienvenido. Aquí se juega en serio, y se juega en equipo.
