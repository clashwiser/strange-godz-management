        ...
        <table>
          ...
          <tbody>
            {[
              ...
              ['/castillo', '"ya doné mi castillo"', t('Anota el castillo de guerra donado; si la API ve donaciones nuevas, suma puntos solo')],
        ...
        <table>
          ...
          <tbody>
            {[
              ...
              ['"ya doné mi castillo"', t('Lo anota y, si la API ve donaciones nuevas, suma los puntos sola')],
