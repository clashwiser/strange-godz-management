...
const SALUD_DEMO = {
  ...
  ia: { configurada: true, motor: 'openai', modelo: 'openai/gpt-oss-120b', busca: 'groq/compound-mini', hoy: 37, fallos: 0, tope: 300 },
};
        ...
        <div className="card">
          ...
          {salud?.ia?.configurada && (
            <p className="sub" style={{ marginTop: 0 }}>
              ...
              {salud.ia.busca && (
                <>
                  {' '}· {t('con web')}: <code>{salud.ia.busca}</code>
                </>
              )}
            </p>
          )}
        ...
        <table>
          ...
          <tbody>
            {[
              ...
              ['/reglas', '"las normas"', t('El resumen de las normas y el enlace a las completas')],
              ['/castillo', '"ya doné mi castillo"', t('Anota el castillo de guerra donado; un líder lo confirma contestando ✅ y suman los puntos')],
              ['/puntos', '"cómo van los puntos"', t('La tabla de puntos de disciplina del mes')],
        ...
        <table>
          ...
          <tbody>
            {[
              ...
              [t('"las normas" / "¿se puede…?"'), t('Manda el resumen de las normas con el enlace; las dudas concretas las contesta con el texto oficial de la pestaña Reglas')],
              ['"ya doné mi castillo"', t('Lo anota; un líder lo confirma contestando ✅ al mensaje y suman los puntos')],
              [t('al final de la entrevista'), t('Hace leer y aceptar las normas antes de anotar la solicitud')],
