...
export const EN = {
  ...
  'Facebook': 'Facebook',
  'Un post al día en los grupos de Clash, como la Página Strange Godz Alliance. Cada grupo, una vez por semana.': 'One post a day in the Clash groups, as the Strange Godz Alliance Page. Each group, once a week.',
  'Últimos 7 días': 'Last 7 days',
  'publicados': 'published',
  'pendientes de aprobación': 'pending approval',
  'reacciones': 'reactions',
  'comentarios': 'comments',
  'Todavía no hay posts. El primero sale a las 10:30 con la PC encendida.': 'No posts yet. The first one goes out at 10:30 with the PC on.',
  'Día': 'Day',
  'Grupo': 'Group',
  'Medido': 'Measured',
  'Publicado': 'Published',
  'Pendiente de aprobación': 'Pending approval',
  'Rechazado por el grupo': 'Rejected by the group',
  'No salió': 'Did not go out',
  'Ver post': 'View post',
  'sin enlace aún': 'no link yet',
  'Buzón de la Página': 'Page inbox',
  'sin atender': 'unanswered',
  'Lo que escriben por Messenger a la Página. Valquiria avisa por Telegram en cuanto llega uno; se contesta desde Facebook y aquí se marca.': 'What people write to the Page on Messenger. Valquiria alerts on Telegram as soon as one arrives; reply from Facebook and mark it here.',
  'Nadie ha escrito al buzón todavía.': 'Nobody has written to the inbox yet.',
  'Abrir conversación': 'Open conversation',
  'Marcar sin atender': 'Mark as unanswered',
  'Ya le contesté': 'I replied',
