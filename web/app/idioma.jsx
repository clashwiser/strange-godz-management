...
export const EN = {
  ...
  'Candidatos en Facebook': 'Facebook candidates',
  'abiertos': 'open',
  'Cada día, en el grupo donde publica, la Página busca jugadores TH18 que piden clan y les contesta en su post con el Telegram y el clan. Valquiria avisa por Telegram de cada uno y de cada respuesta; el caso se cierra aquí.': 'Every day, in the group where it posts, the Page looks for TH18 players asking for a clan and replies on their post with the Telegram and the clan. Valquiria alerts on Telegram about each one and each reply; the case is closed here.',
  'Todavía no hay candidatos. El rastreo va con el post de cada día.': 'No candidates yet. The scan runs with each day\'s post.',
  'Lo que puso': 'What they posted',
  'Abrir su post': 'Open their post',
  'Le contestamos': 'We replied',
