...
const ADORNOS = {
  ...
  'ѕ': 's', 'ս': 's', 'տ': 's', '$': 's',
  // El alfabeto "tachado" de los generadores de nombres (₳฿₵ĐɆ₣₲ⱧłJ₭Ⱡ₥₦Ø₱QⱤ₴₮ɄV₩ӾɎⱫ),
  // que NFKD no toca: «꧁Ø︎VɆⱤⱧ₳₥₥ɆⱤ꧂» quedaba en "ov" y la foto de su castillo no cuadraba (14 sep 2026).
  '₳': 'a', '฿': 'b', '₵': 'c', 'đ': 'd', 'ɇ': 'e', '₣': 'f', '₲': 'g', 'ⱨ': 'h', 'ł': 'l', '₭': 'k', 'ⱡ': 'l', '₥': 'm', '₦': 'n', '₱': 'p', 'ɋ': 'q', 'ɽ': 'r', '₴': 's', '₮': 't', 'ŧ': 't', 'ʉ': 'u', '₩': 'w', 'ӿ': 'x', 'ɏ': 'y', 'ⱬ': 'z', 'ꞩ': 's', 'ƀ': 'b', 'ȼ': 'c', 'ǥ': 'g', 'ɨ': 'i', 'ɉ': 'j', 'ꝁ': 'k', 'ⱥ': 'a', 'ꝍ': 'o', 'ꞥ': 'n', 'ꝑ': 'p', 'ꝗ': 'q', 'ꞧ': 'r', 'ꞇ': 't', 'ꝟ': 'v', 'ꝥ': 'y',
